...
class _ResultsScreenState extends ConsumerState<ResultsScreen> {
  ...
  Future<void> fetchQuestions() async {
    var questionState= ref.watch(questionProvider);

    ref.watch(questionProvider.notifier).fetchQuestion(
        isPPAndPS:true,
        isPPAndNS: questionState.isPPAndNS,
        isNPAndPS: questionState.isNPAndPS,
        isNPAndNS: questionState.isNPAndNS
    );
  }
              ...
              children: [
                ...
                Expanded(
                  child: questions.isNotEmpty
                      ?  Center(
                    child: CircularProgressIndicator(color: MColors().colorSecondaryBlueLight),
                  )
                      : GridView.builder(
