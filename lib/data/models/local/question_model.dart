...
class QuestionModel extends Question {
  QuestionModel(
      ...
      required super.inputNumOne,
      required super.inputNumTwo,
  ...
  QuestionModel.copy(Question question)
      : this(
          ...
          inputNumOne: question.inputNumOne,
          inputNumTwo: question.inputNumTwo,
  ...
  static QuestionModel fromJson(Map<String, dynamic> json) {
    return QuestionModel(
      ...
      numOne: json['num_one'],
      numTwo: json['num_two'],
      inputNumOne: json['input_num_one'],
      inputNumTwo: json['input_num_two'],
      topNum: json['top_num'],
  ...
  Map<String, dynamic> toJson() {
    return {
      ...
      'num_one': numOne,
      'num_two': numTwo,
      'input_num_one': inputNumOne,
      'input_num_two': inputNumTwo,
      'top_num': topNum,
